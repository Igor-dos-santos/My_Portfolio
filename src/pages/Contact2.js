...
function Contact() {
  ...
  const sendEmail = () => {
    ...
    emailjs.send('service_qbs62hj', 'template_zx5j0c6', templateParams, 'lORh4reJUfpD_-E__')
      .then((response) => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Contact - React Personal Portfolio</title>
        <meta
          name="description"
          content="React Personal Portfolio Contact Page"
        />
      </Helmet>
